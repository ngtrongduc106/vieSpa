...
public class Contract {
    public static void print(Transaction transaction) throws Exception{
        ...
        try {
            writer = new BufferedWriter(new FileWriter("..\\contracts\\contract_"+transaction.getId().toString()+".html"));
            ...
            String price = String.format("<h4>Điều 5. Tiền dịch vụ và phương thức thanh toán:</h4><p>1. Tiền dịch vụ: Thực hiện công việc tại Điều 1 là: %s , chưa bao gồm tiền thuế giá trị gia tăng.</p><p>2. Phương thức thanh toán: chuyển khoản 100%</p><h4>Điều 6. Chi phí khác</h4><p>Không được phép phát sinh thêm chi phí khác</p>",
                    transaction.getPay());
            writer.write(price);
